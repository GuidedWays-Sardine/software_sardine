...
Item {
    ...
    readonly property bool isChecked: false
    ...
    width: (box_lenght - 2) * root.ratio
    height: (box_lenght - 2) * root.ratio
    ...
    Image {
        id: image
        source: isActivated ? (darkGrey ? "../DMI_images/dark_grey_cross.png" : "../DMI_images/white_cross.png") : ""
        anchors.fill: parent
