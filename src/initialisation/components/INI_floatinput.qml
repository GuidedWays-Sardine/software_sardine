...
Item{
    ...
    property double default_x: 0                //position du floatinput pour les dimensions minimales de la fenêtre (w_min*h_min)
    property double default_y: 0
    property double default_width: 100          //dimensions du floatinput pour les dimensions minimales de la fenêtre (w_min*h_min)
    ...
    //permet de centrer la fenêtre lorsque le ratio de la fenêtre n'est pas la même que celui utilisé (4:3)
    ...
    onUnitChanged: {
        // Dans le cas ou une unité est entrée
        if (root.unit !== "") {
    ...
    TextField {
        ...
        MouseArea
        {
            ...
            onDoubleClicked: {
                //Cas où la liste de conversion contient plus d'un élément
